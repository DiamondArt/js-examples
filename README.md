...
### Ternary
- [:mag: examples](https://github.com/nan-ci/js-example/blob/masters/07-ternary.js)
...
### Event
- [:mag: examples](https://github.com/nan-ci/js-examples/master/blob/master11-event.js)
